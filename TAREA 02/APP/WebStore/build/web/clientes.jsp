<%-- 
    Document   : clientes
    Created on : Mar 23, 2016, 4:22:43 PM
    Author     : marlon
--%>
    ...
    <html>
        ...
        <div class="col-lg-12 main">
            <div class="row"><br/>
                ...
                <div class="col-lg-10">
                    <div class="panel panel-default">
                        <div class="modal fade" id="myModalInsertarCliente" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                        ...
                        <div class="panel-heading">
                            <div class="col-lg-6">
                                <a class="btn btn-primary" data-toggle="modal" data-target="#myModalInsertarCliente"><svg class="glyph stroked plus sign"><use xlink:href="#stroked-plus-sign"/></svg>Agregar clientes</a>
                                <a href="ClienteBean?action=listar" class="btn btn-primary"><svg class="glyph stroked clipboard with paper"><use xlink:href="#stroked-clipboard-with-paper"/></svg>Ver registros</a>
                            </div>
                        </div>
                                ...
                                <tbody>
                                    <c:forEach items="${clientes}" var="item">
                                        <tr>
                                            ...
                                            <td><a class="btn btn-primary" href="ClienteBean?action=edit&idcliente=<c:out value="${item.idcliente}"/>"><span class="glyphicon glyphicon-refresh" aria-hidden="true"></span></a>
                                                <a class="btn btn-danger" href="ClienteBean?action=delete&idcliente=<c:out value="${item.idcliente}"/>"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span></a></td>
                                        </tr>
                                    </c:forEach>
                                </tbody>
                            </table>
