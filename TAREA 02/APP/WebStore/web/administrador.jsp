<%-- 
    ...
    Created on : Mar 23, 2016, 3:52:25 PM
    Author     : marlon
--%>
                        ...
                        <div class="panel-body">
                            <form class="form-horizontal" role="form" method="POST" action="AdministradorBean" name="frmAdmin">
                                <div class="form-group">
                                    <label for="idadmin" class="col-sm-2 control-label">ID Cajero</label>
                                    <div class="col-sm-10">                                    
                                        <input class="form-control" id="idadmin" maxlength="11" type="text" readonly="readonly" name="idadmin" value="<c:out value="${elemento.idadministrador}" />" />
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="btn-group btn-group-justified" role="group" aria-label="...">
                                    ...
                                    <div class="btn-group" role="group">
                                        <a href="AdministradorBean?action=listar" class="btn btn-danger">Cancelar</a>
                                    </div>
                                </div>
                            </form>
                        </div>
