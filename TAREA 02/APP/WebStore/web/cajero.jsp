<%-- 
    Document   : cajero
    Created on : Mar 22, 2016, 11:33:17 PM
    Author     : marlon
--%>
                        ...
                        <div class="panel-body">
                            <form class="form-horizontal" role="form" method="POST" action="CajeroBean" name="frmCajero">
                                <div class="form-group">
                                    <label for="idcajero" class="col-sm-2 control-label">ID Cajero</label>
                                    <div class="col-sm-10">                                    
                                        <input class="form-control" id="idcajero" maxlength="11" type="text" readonly="readonly" name="idcajero" value="<c:out value="${elemento.idcajero}" />" />
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="btn-group btn-group-justified" role="group" aria-label="...">
                                    ...
                                    <div class="btn-group" role="group">
                                        <a href="CajeroBean?action=listar" class="btn btn-danger">Cancelar</a>
                                    </div>
                                </div>
                            </form>
                        </div>
