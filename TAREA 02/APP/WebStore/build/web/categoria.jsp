<%-- 
    Document   : categoria
    Created on : Mar 23, 2016, 1:23:53 PM
    Author     : marlon
--%>
                ...
                <div class="col-lg-10">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <form class="form-horizontal" role="form" method="POST" action="CategoriaBean" name="frmCategoria">
                                <div class="form-group">
                                    <label for="idcategoria" class="col-sm-2 control-label">ID Cajero</label>
                                    <div class="col-sm-10">                                    
                                        <input class="form-control" id="idcategoria" maxlength="11" type="text" readonly="readonly" name="idcategoria" value="<c:out value="${elemento.idcategoria}" />" />
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="btn-group btn-group-justified" role="group" aria-label="...">
                                    ...
                                    <div class="btn-group" role="group">
                                        <a href="CategoriaBean?action=listar" class="btn btn-danger">Cancelar</a>
                                    </div>
                                </div>
                            </form>
                        </div>
