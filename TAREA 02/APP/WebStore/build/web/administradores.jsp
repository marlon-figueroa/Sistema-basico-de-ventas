<%-- 
    ...
    Created on : Mar 23, 2016, 3:52:05 PM
    Author     : marlon
--%>
                ...
                <div class="col-lg-2">
                    <div class="panel panel-default">
                        <ul class="nav nav-pills nav-stacked">
                            ...
                            <li class="active"><a href="AdministradorBean?action=listar">Administrador</a></li>
                ...
                <div class="col-lg-10">
                    <div class="panel panel-default">
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        ...
                                        <h4 class="modal-title" id="myModalLabel">INFORMACION DEL ADMINISTRADOR</h4>
                                    </div>
                                    <div class="modal-body">
                                        <form class="form-horizontal" role="form" method="POST" action="AdministradorBean" name="frmAdmin">
                        ...
                        <div class="panel-heading">
                            <div class="col-lg-6">
                                <a class="btn btn-primary" data-toggle="modal" data-target="#myModalInsertarCajero"><svg class="glyph stroked plus sign"><use xlink:href="#stroked-plus-sign"/></svg>Agregar administrador</a>
                                <a href="AdministradorBean?action=listar" class="btn btn-primary"><svg class="glyph stroked clipboard with paper"><use xlink:href="#stroked-clipboard-with-paper"/></svg>Ver registros</a>
                            </div>
                        </div>
                            ...
                            <table data-toggle="table" data-show-refresh="true" data-show-toggle="true" data-show-columns="true" data-search="true" data-select-item-name="toolbar1" data-pagination="true" data-sort-name="name" data-sort-order="desc">
                                ...
                                <tbody>
                                    <c:forEach items="${admins}" var="item">
                                        <tr>
                                            <td><c:out value="${item.idadministrador}" /></td>
                                            <td><c:out value="${item.idadministrador}" /></td>
                                            ...
                                            <td><a class="btn btn-primary" href="AdministradorBean?action=edit&idadmin=<c:out value="${item.idadministrador}"/>"><span class="glyphicon glyphicon-refresh" aria-hidden="true"></span></a>
                                                <a class="btn btn-danger" href="AdministradorBean?action=delete&idadmin=<c:out value="${item.idadministrador}"/>"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span></a></td>
                                        </tr>
                                    </c:forEach>
                                </tbody>
                            </table>
