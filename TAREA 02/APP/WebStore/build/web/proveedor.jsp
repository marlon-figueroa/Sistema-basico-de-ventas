<%-- 
    Document   : proveedor
    Created on : Mar 23, 2016, 4:51:58 PM
    Author     : marlon
--%>
                        ...
                        <div class="panel-body">
                            <form class="form-horizontal" role="form" method="POST" action="ProveedorBean" name="frmProveedor">
                                <div class="form-group">
                                    <label for="idproveedor" class="col-sm-2 control-label">ID Proveedor</label>
                                    <div class="col-sm-10">                                    
                                        <input class="form-control" id="idproveedor" maxlength="11" type="text" readonly="readonly" name="idproveedor" value="<c:out value="${elemento.idproveedor}" />" />
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="btn-group btn-group-justified" role="group" aria-label="...">
                                    ...
                                    <div class="btn-group" role="group">
                                        <a href="ProveedorBean?action=listar" class="btn btn-danger">Cancelar</a>
                                    </div>
                                </div>
                            </form>
                        </div>
