<%-- 
    Document   : marca
    Created on : Mar 23, 2016, 1:23:29 PM
    Author     : marlon
--%>
                        ...
                        <div class="panel-body">
                            <form class="form-horizontal" role="form" method="POST" action="MarcaBean" name="frmMarca">
                                <div class="form-group">
                                    <label for="idmarca" class="col-sm-2 control-label">ID Marca</label>
                                    <div class="col-sm-10">                                    
                                        <input class="form-control" id="idmarca" maxlength="11" type="text" readonly="readonly" name="idmarca" value="<c:out value="${elemento.idmarca}" />" />
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="btn-group btn-group-justified" role="group" aria-label="...">
                                    ...
                                    <div class="btn-group" role="group">
                                        <a href="MarcaBean?action=listar" class="btn btn-danger">Cancelar</a>
                                    </div>
                                </div>
                            </form>
                        </div>
