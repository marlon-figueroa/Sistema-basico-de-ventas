<%-- 
    Document   : producto
    Created on : Mar 23, 2016, 1:24:23 PM
    Author     : marlon
--%>
                        ...
                        <div class="panel-body">
                            <form class="form-horizontal" role="form" method="POST" action="ProductoBean" name="frmProducto">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">                                    
                                        <input class="form-control" id="idproducto"  maxlength="11" type="text" name="idproducto" readonly="readonly" required="true" value="<c:out value="${elemento.idproducto}"/>"/>
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">                                    
                                        <input class="form-control" id="txtpreciouni" maxlength="5" type="text" name="txtpreciouni" required="true" value="<c:out value="${elemento.precioUni}"/>"/>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="txtstock" class="col-sm-2 control-label">Cantidad</label>
                                    <div class="col-sm-10">                                    
                                        <input class="form-control" id="txtstock" maxlength="11" type="number" name="txtstock" required="true" value="<c:out value="${elemento.stock}"/>"/>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="datepicker" class="col-sm-2 control-label">Fecha de vencimiento</label>
                                    <div class="col-sm-10">                                    
                                        <input class="form-control" id="datepicker" maxlength="10" type="text" name="txtfechavenci" required="true" value="<c:out value="${elemento.fechaVenci}"/>"/>
                                    </div>
                                </div>
                                <div class="form-group">
