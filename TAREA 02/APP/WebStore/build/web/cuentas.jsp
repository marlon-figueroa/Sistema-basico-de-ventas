<%-- 
    Document   : cuentas
    Created on : Mar 23, 2016, 5:57:42 PM
    Author     : marlon
--%>
    ...
    <html>
        ...
        <div class="col-lg-12 main">
            <div class="row"><br/>
                ...
                <div class="col-lg-10">
                    <div class="panel panel-default">
                        <div class="modal fade" id="myModalInsertarCuentas" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                                        <h4 class="modal-title" id="myModalLabel">INFORMACION DEL CUENTA</h4>
                                    </div>
                                    <div class="modal-body">
                                        <form class="form-horizontal" role="form" method="POST" action="CuentaBean" name="frmCajero">
                                            <div class="form-group">
                                                <label for="txtusername" class="col-sm-2 control-label">Username</label>
                                                <div class="col-sm-10">                                    
                                                    <input class="form-control" id="txtnombre"  maxlength="45" type="text" name="username" required="true"/>
                                                </div>
                                            </div> 
                                            <div class="form-group">
                                                <label for="txtpassword" class="col-sm-2 control-label">Password</label>
                                                <div class="col-sm-10">                                    
                                                    <input class="form-control" id="txtpassword"  maxlength="45" type="text" name="password" required="true"/>
                                                </div>
                                            </div> 
                        ...
                        <div class="panel-heading">
                            <div class="col-lg-6">
                                <a class="btn btn-primary" data-toggle="modal" data-target="#myModalInsertarCuentas"><svg class="glyph stroked plus sign"><use xlink:href="#stroked-plus-sign"/></svg>Agregar cuenta</a>
                                <a href="CuentaBean?action=listar" class="btn btn-primary"><svg class="glyph stroked clipboard with paper"><use xlink:href="#stroked-clipboard-with-paper"/></svg>Ver registros</a>
                            </div>
                        </div>
                            ...
                            <table data-toggle="table" data-show-refresh="true" data-show-toggle="true" data-show-columns="true" data-search="true" data-select-item-name="toolbar1" data-pagination="true" data-sort-name="name" data-sort-order="desc">
                                ...
                                <tbody>
                                    <c:forEach items="${cuentas}" var="item">
                                        <tr>
                                            <td><c:out value="${item.idcuenta}" /></td>
                                            <td><c:out value="${item.idcuenta}" /></td>
                                            <td><c:out value="${item.username}" /></td>
                                            <td><c:out value="${item.password}" /></td>
                                            <td><a class="btn btn-primary" href="CuentaBean?action=edit&idcuenta=<c:out value="${item.idcuenta}"/>"><span class="glyphicon glyphicon-refresh" aria-hidden="true"></span></a>
                                                <a class="btn btn-danger" href="CuentaBean?action=delete&idcuenta=<c:out value="${item.idcuenta}"/>"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span></a></td>
                                        </tr>
                                    </c:forEach>
                                </tbody>
                            </table>
