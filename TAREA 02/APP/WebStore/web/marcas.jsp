<%-- 
    Document   : marcas
    Created on : Mar 23, 2016, 1:23:18 PM
    Author     : marlon
--%>
    ...
    <html>
        ...
        <div class="col-lg-12 main">
            <div class="row"><br/>
                <div class="col-lg-2">
                    <div class="panel panel-default">
                        <ul class="nav nav-pills nav-stacked">
                            ...
                            <li class="active"><a href="MarcaBean?action=listar">Marca</a></li>
                ...
                <div class="col-lg-10">
                    <div class="panel panel-default">
                        <div class="modal fade" id="myModalInsertarMarca" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                                        <h4 class="modal-title" id="myModalLabel">INFORMACION DEL MARCA</h4>
                                    </div>
                                    <div class="modal-body">
                                        <form class="form-horizontal" role="form" method="POST" action="MarcaBean" name="frmMarca">
                        ...
                        <div class="panel-heading">
                            <div class="col-lg-6">
                                <a class="btn btn-primary" data-toggle="modal" data-target="#myModalInsertarMarca"><svg class="glyph stroked plus sign"><use xlink:href="#stroked-plus-sign"/></svg>Agregar marca</a>
                                <a href="MarcaBean?action=listar" class="btn btn-primary"><svg class="glyph stroked clipboard with paper"><use xlink:href="#stroked-clipboard-with-paper"/></svg>Ver registros</a>
                            </div>
                        </div>
                            ...
                            <table data-toggle="table" data-show-refresh="true" data-show-toggle="true" data-show-columns="true" data-search="true" data-select-item-name="toolbar1" data-pagination="true" data-sort-name="name" data-sort-order="desc">
                                ...
                                <tbody>
                                    <c:forEach items="${marcas}" var="item">
                                        <tr>
                                            <td><c:out value="${item.idmarca}" /></td>
                                            <td><c:out value="${item.idmarca}" /></td>
                                            <td><c:out value="${item.nombre}" /></td>
                                            <td><a class="btn btn-primary" href="MarcaBean?action=edit&idmarca=<c:out value="${item.idmarca}"/>" ><span class="glyphicon glyphicon-refresh" aria-hidden="true"></span></a>
                                                <a class="btn btn-danger" href="MarcaBean?action=delete&idmarca=<c:out value="${item.idmarca}"/>"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span></a></td>
                                        </tr>
                                    </c:forEach>
                                </tbody>
                            </table>
