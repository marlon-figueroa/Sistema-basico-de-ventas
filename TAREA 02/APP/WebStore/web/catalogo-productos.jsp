<%-- 
    ...
    Created on : Mar 23, 2016, 1:25:21 PM
    Author     : marlon
--%>
                ...
                <div class="col-lg-10">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <div class="col-lg-6">
                                <a class="btn btn-primary" href="productos.jsp"><svg class="glyph stroked plus sign"><use xlink:href="#stroked-plus-sign"/></svg>Agregar clientes</a>
                                <a href="ProductoBean?action=listar" class="btn btn-primary"><svg class="glyph stroked clipboard with paper"><use xlink:href="#stroked-clipboard-with-paper"/></svg>Ver registros</a>
                            </div>
                        </div>
                            ...
                            <table data-toggle="table" data-show-refresh="true" data-show-toggle="true" data-show-columns="true" data-search="true" data-select-item-name="toolbar1" data-pagination="true" data-sort-name="name" data-sort-order="desc">
                                <thead>
                                    <tr>
                                        ...
                                        <th data-field="preciouni"  data-sortable="true">Precio unitario</th>
                                        <th data-field="stock"  data-sortable="true">Existencia</th>
                                        <th data-field="fechavenci"  data-sortable="true">Fecha de vencimiento</th>
                                ...
                                <tbody>
                                    <c:forEach items="${productos}" var="item">
                                        <tr>
                                            ...
                                            <td><c:out value="${item.precioUni}" /></td>
                                            <td><c:out value="${item.stock}" /></td>
                                            <td><c:out value="${item.fechaVenci}" /></td>
                                            <td><c:out value="${item.categoriaIdcategoria}" /></td>
                                            <td><c:out value="${item.marcaIdmarca}" /></td>
                                            <td><c:out value="${item.proveedorIdproveedor}" /></td>
                                            <td><a class="btn btn-primary" href="ProductoBean?action=edit&idproducto=<c:out value="${item.idproducto}"/>"><span class="glyphicon glyphicon-refresh" aria-hidden="true"></span></a>
                                                <a class="btn btn-danger" href="ProductoBean?action=delete&idproducto=<c:out value="${item.idproducto}"/>"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span></a></td>
                                        </tr>
                                    </c:forEach>
                                </tbody>
                            </table>
